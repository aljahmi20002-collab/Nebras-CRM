...
| **البيانات** | SQLite بوضع WAL افتراضياً أو MariaDB / MySQL / PostgreSQL لخادم شبكي · حذف ناعم · سجل تدقيق |
...
- [ ] اختيار وضبط MariaDB أو PostgreSQL للأحمال المتزامنة العالية
